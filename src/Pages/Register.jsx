  ...
  return (
    <div>
      <div className="flex flex-col items-center min-h-screen pt-3 sm:justify-center sm:pt-0 bg-gray-50">
        <div>
          <h3 className="text-4xl font-sans font-bold text-blue-400 tracking-2">
            REGISTRATION
          </h3>
          <hr />
        </div>
         ...
         <Link to={'/ForgotPass'}>
            ...
            <div className="flex items-center mt-4">
              <button
                ...
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-700 focus:outline-none"
              >
                Register
              </button>
            </div>
